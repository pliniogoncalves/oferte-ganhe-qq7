...
async function insertSending(quantidade, data, usuario, talao, loja) {
    const query = `
        INSERT INTO postgres."oferte-ganhe".Envio (quantidade_envio, data_envio, id_usuario, id_talao, id_loja)
        VALUES ($1, $2, 
